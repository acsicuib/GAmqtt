...
if executionConfig.executionConfig == 'semidistributed':
...
#executionScenario = 'centralizedNSGA'
    executionScenario = executionConfig.executionConfig
    numOfWorkers = 20
...
if executionConfig.executionConfig == 'fullydistributed':
...
if executionConfig.executionConfig == 'neighboraware':
